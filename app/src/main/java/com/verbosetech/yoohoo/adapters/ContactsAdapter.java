...
public class ContactsAdapter extends RecyclerView.Adapter<ContactsAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        if (dataListTelephone != null) holder.setData(dataListTelephone.get(position));
        else if (dataListEmail != null) holder.setData(dataListEmail.get(position));
    }

    @Override
    public int getItemCount() {
        if (dataListTelephone != null) return dataListTelephone.size();
        else if (dataListEmail != null) return dataListEmail.size();
        else return 0;
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            } else itemView.findViewById(R.id.phoneCall).setVisibility(View.GONE);
        }
