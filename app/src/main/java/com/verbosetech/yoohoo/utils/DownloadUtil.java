...
public class DownloadUtil {
    ...
    private void downloadFile(Context context, String url, String type, String fileName) {
        ...
        request.setAllowedNetworkTypes(DownloadManager.Request.NETWORK_WIFI | DownloadManager.Request.NETWORK_MOBILE).setAllowedOverRoaming(false).setTitle(context.getString(R.string.app_name)).setDescription("Downloading " + fileName).setNotificationVisibility(DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED).setDestinationInExternalPublicDir(getDirectoryPath(context) + "/" + type, fileName);
        mgr.enqueue(request);
    }
