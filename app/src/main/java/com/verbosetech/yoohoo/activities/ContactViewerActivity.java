    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (attachment != null) {
                    File file = new File(Environment.getExternalStorageDirectory() + "/" + getString(R.string.app_name) + "/" + "Contact" + (isMine ? "/.sent/" : ""), attachment.getName());
                    if (file.exists()) {
                        Intent intent = new Intent(Intent.ACTION_VIEW);
                        Uri uri = FileProvider.getUriForFile(ContactViewerActivity.this, getString(R.string.authority), file);
