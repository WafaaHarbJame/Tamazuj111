...
public class IncomingCallScreenActivity extends BaseActivity {
    ...
    private void notifyMisscall(LogCall logCall) {
        ...
        notificationBuilder.setSmallIcon(R.drawable.noti_icon).setContentTitle(logCall.getUserName()).setContentText(getString(R.string.gave_miss)).setAutoCancel(true).setSound(defaultSoundUri).setContentIntent(pendingIntent);
        int msgId = 0;
        try {
