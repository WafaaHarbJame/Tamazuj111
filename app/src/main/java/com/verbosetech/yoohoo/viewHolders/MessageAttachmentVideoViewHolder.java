...
public class MessageAttachmentVideoViewHolder extends BaseMessageViewHolder {
    ...
    public void setData(Message message, int position) {
        ...
        file = new File(Environment.getExternalStorageDirectory() + "/" + context.getString(R.string.app_name) + "/" + AttachmentTypes.getTypeName(message.getAttachmentType()) + (isMine() ? "/.sent/" : ""), message.getAttachment().getName());
...
//            }
    ...
    public void downloadFile() {
        if (!Helper.CHAT_CAB) if (file.exists()) {
