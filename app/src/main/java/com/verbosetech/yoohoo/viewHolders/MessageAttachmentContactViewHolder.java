    ...
    public MessageAttachmentContactViewHolder(View itemView, OnMessageItemClick itemClickListener) {
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!Helper.CHAT_CAB) dialogVCardDetail();
                onItemClick(true);
            }
        });
    ...
    private void dialogVCardDetail() {
        ...
        if (myDialog1 == null) {
            ...
            myDialog1.findViewById(R.id.contactAdd).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (message != null) {
                        File file = new File(Environment.getExternalStorageDirectory() + "/" + context.getString(R.string.app_name) + "/" + AttachmentTypes.getTypeName(message.getAttachmentType()) + (isMine() ? "/.sent/" : ""), message.getAttachment().getName());
                        if (file.exists()) {
                        ...
                        } else if (!isMine()) broadcastDownloadEvent();
                        else Toast.makeText(context, "File unavailable", Toast.LENGTH_SHORT).show();
