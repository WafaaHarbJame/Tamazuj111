...
public class MessageAttachmentImageViewHolder extends BaseMessageViewHolder {
    ...
    public void setData(final Message message, int position) {
        ...
        Glide.with(context).load(message.getAttachment().getUrl()).apply(new RequestOptions().placeholder(R.drawable.yoohoo_placeholder).diskCacheStrategy(DiskCacheStrategy.ALL)).into(image);
